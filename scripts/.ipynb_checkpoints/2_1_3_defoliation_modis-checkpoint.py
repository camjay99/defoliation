...
description = f'MODIS_unscaled_{args.geometry}_Defoliation'
assetID = f'projects/{args.project}/assets/{args.geometry}_Defoliation/MODIS_unscaled'

phenology = ee.Image(f'projects/{args.project}/assets/{args.geometry}_Phenology_Maps/MODIS')
models = ee.Image(f'projects/{args.project}/assets/{args.geometry}_Trends/MODIS_unscaled')
...
def calc_statistics(images): 
    ...
    return mean_intensity.set("method", "MODIS_unscaled").set('year', year)
