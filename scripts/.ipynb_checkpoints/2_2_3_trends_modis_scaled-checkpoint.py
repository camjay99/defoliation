...
description = f'MODIS_{args.geometry}_Defoliation'
assetID = f'projects/{args.project}/assets/{args.geometry}_Defoliation/MODIS'

phenology = ee.Image(f'projects/{args.project}/assets/{args.geometry}_Phenology_Maps/MODIS')
models = ee.Image(f'projects/{args.project}/assets/{args.geometry}_Trends/MODIS')
...
def calc_statistics(images): 
    ...
    return defol.set('method', 'MODIS').set('year', year)
