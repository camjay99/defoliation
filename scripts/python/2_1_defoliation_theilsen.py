...
if args.cloudstorage:
    ...
    file_name_prefix = f'defoliation_score_{name}/defoliation_score_{args.data}'
    image_manifests = {}
    if args.rescale:
        file_name_prefix += '_rescaled'
assetID = f'projects/{args.project}/assets/defoliation_score_{name}/defoliation_score_{args.data}'
...
for i in range(gridSize):
    ...
    models = models.map(decompress).mosaic()
