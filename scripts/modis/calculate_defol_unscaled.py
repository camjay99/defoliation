...
# description = 'MODIS_unscaled_Mt_Pleasant_Defol'
# assetID = 'Mt_Pleasant_Defoliation/MODIS_unscaled'

# phenology = ee.Image('projects/ee-cjc378/assets/Mt_Pleasant_Phenology_Maps/MODIS')

# models = ee.Image("projects/ee-cjc378/assets/Mt_Pleasant_Trends/MODIS_unscaled")
...
# description = 'MODIS_unscaled_Allegheny_Defoliation'
# assetID = 'Allegheny_Defoliation/MODIS_unscaled'

# phenology = ee.Image('projects/ee-cjc378/assets/Allegheny_Phenology_Maps/MODIS')

# models = ee.Image("projects/ee-cjc378/assets/Allegheny_Trends/MODIS_unscaled")
...
# description = 'MODIS_unscaled_NJPB_Defoliation'
# assetID = 'NJPB_Defoliation/MODIS_unscaled'

# phenology = ee.Image('projects/ee-cjc378/assets/NJPB_Phenology_Maps/MODIS')

# models = ee.Image("projects/ee-cjc378/assets/NJPB_Trends/MODIS_unscaled")
...
# description = 'MODIS_unscaled_Turkey_Point_Defoliaiton'
# assetID = 'Turkey_Point_Defoliation/MODIS_unscaled'

# phenology = ee.Image('projects/ee-cjc378/assets/Turkey_Point_Phenology_Maps/MODIS')

# models = ee.Image("projects/ee-cjc378/assets/Turkey_Point_Trends/MODIS_unscaled")
...
# description = 'MODIS_unscaled_Arnot_Forest_Defoliation'
# assetID = 'Arnot_Forest_Defoliation/MODIS_unscaled'

# phenology = ee.Image('projects/ee-cjc378/assets/Arnot_Forest_Phenology_Maps/MODIS')

# models = ee.Image("projects/ee-cjc378/assets/Arnot_Forest_Trends/MODIS_unscaled")
...
description = 'MODIS_unscaled_Adirondacks_Defoliation'
assetID = 'Adirondacks_Defoliation/MODIS_unscaled'

phenology = ee.Image('projects/ee-cjc378/assets/Adirondacks_Phenology_Maps/MODIS')

models = ee.Image("projects/ee-cjc378/assets/Adirondacks_Trends/MODIS_unscaled")
...
def calc_statistics(images): 
    ...
    return defol.set("method", "MODIS_unscaled")
...
for year in range(START_YEAR, END_YEAR+1):
    defol = calc_statistics(TOC.filterDate(ee.Date.fromYMD(year, 1, 1), ee.Date.fromYMD(year+1, 1, 1))).set('system:index', str(year))
