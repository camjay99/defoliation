...
# description = 'Landsat_Quabbin_Defol'
# assetID = 'Quabbin_Defoliation/Landsat'

# # Load SoS/EoS map
# phenology = ee.Image('projects/ee-cjc378/assets/Quabbin_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/Quabbin_Trends/Landsat")
...
# description = 'Landsat_Mt_Pleasant_Defol'
# assetID = 'Mt_Pleasant_Defoliation/Landsat'

# phenology = ee.Image('projects/ee-cjc378/assets/Mt_Pleasant_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/Mt_Pleasant_Trends/Landsat")
...
# description = 'Landsat_Allegheny_Defoliation'
# assetID = 'Allegheny_Defoliation/Landsat'

# phenology = ee.Image('projects/ee-cjc378/assets/Allegheny_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/Allegheny_Trends/Landsat")
...
# description = 'Landsat_NJPB_Defoliation'
# assetID = 'NJPB_Defoliation/Landsat'

# phenology = ee.Image('projects/ee-cjc378/assets/NJPB_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/NJPB_Trends/Landsat")
...
# description = 'Landsat_Turkey_Point_Defoliation'
# assetID = 'Turkey_Point_Defoliation/Landsat'

# phenology = ee.Image('projects/ee-cjc378/assets/Turkey_Point_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/Turkey_Point_Trends/Landsat")
...
# description = 'Landsat_Arnot_Forest_Defoliation'
# assetID = 'Arnot_Forest_Defoliation/Landsat'

# phenology = ee.Image('projects/ee-cjc378/assets/Arnot_Forest_Phenology_Maps/Landsat')

# models = ee.Image("projects/ee-cjc378/assets/Arnot_Forest_Trends/Landsat")
...
description = 'Landsat_Adirondacks_Defoliation'
assetID = 'Adirondacks_Defoliation/Landsat'

phenology = ee.Image('projects/ee-cjc378/assets/Adirondacks_Phenology_Maps/Landsat')

models = ee.Image("projects/ee-cjc378/assets/Adirondacks_Trends/Landsat")
...
def calc_statistics(images): 
    ...
    # Note count is broken for some reason...
    ...
    return defol.set('method', 'Landsat')
...
for year in range(START_YEAR, END_YEAR+1):
    defol = calc_statistics(ls_scaled.filterDate(ee.Date.fromYMD(year, 1, 1), ee.Date.fromYMD(year+1, 1, 1))).set('system:index', str(year))
