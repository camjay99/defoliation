...
# assetID = 'Quabbin_Trends/Landsat_unscaled'
...
# description = 'Landsat_unscaled_Mt_Pleasant_Trend'
# assetID = 'Mt_Pleasant_Trends/Landsat_unscaled'
...
# description = 'Landsat_unscaled_Allegheny_Trends'
# assetID = 'Allegheny_Trends/Landsat_unscaled'
...
# description = 'Landsat_unscaled_NJPB_Trends'
# assetID = 'NJPB_Trends/Landsat_unscaled'
...
# description = 'Landsat_unscaled_Turkey_Point_Trends'
# assetID = 'Turkey_Point_Trends/Landsat_unscaled'
...
# description = 'Landsat_unscaled_Arnot_Forest_Trends'
# assetID = 'Arnot_Forest_Trends/Landsat_unscaled'
...
description = 'Landsat_unscaled_Trends_Phenology'
assetID = 'Adirondacks_Trends/Landsat_unscaled'
...
#mean = ls.select('EVI').mean()
#std = ls.select('EVI').reduce(ee.Reducer.stdDev())
...
ss = ls.select(['doy', 'EVI']).reduce(ee.Reducer.sensSlope())
